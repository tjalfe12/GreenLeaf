...
class MySQL
{
    ...
    function __construct($autoConnect = false)
    {
        ...
        $this->SetServer($this->server, $this->username, $this->password, $this->port);
    ...
    public function SetServer($server, $username, $password, $port)
    {
        $this->server = $server;
    ...
    {
        $this->mySQL = new mysqli($this->server, $this->username, $this->password, $this->database, $this->port);
